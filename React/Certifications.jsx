...
function Certifications(props) {
    ...
    useEffect(() => {
        ...
        certificationService.getByConferenceId(0, pageData.pageSize, renderingData.conferenceId).then(onGetPagedCertificationsSuccess).catch(onGetCertificationsError)
        certificationService.getAll(0, 100).then(onGetAllCertificationsSuccess).catch(onGetCertificationsError)
    ...
    useEffect(() => {
        certificationService.getByConferenceId(pageData.pageIndex, pageData.pageSize, renderingData.conferenceId).then(onGetPagedCertificationsSuccess).catch(onGetCertificationsError)
    }, [pageData.pageIndex])
    ...
    const onGetPagedCertificationsSuccess = (data) => {
        ...
        setPageData((prevState) => {
            ...
            newState.certificationsComponents = certificationsArray.map(mapCertification)
    ...
    const onGetAllCertificationsSuccess = (data) => {
        ...
        setPageData((prevState) => {
            ...
            const newState = { ...prevState }
            newState.allCertifications = certificationsArray.filter(certObject => certObject.season.conference.id === Number(renderingData.conferenceId));
    ...
    const onGetSeasonsSuccess = (data) => {
        ...
        setRenderingData(prevState => ({ ...prevState, seasonsOptions: mappedArray }));
    }
    ...
    const onDeleteCertification = (aCertification) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                certificationService.delete(idToDelete).then(handler).catch(onDeleteCertificationError);
    ...
    const getDeleteSuccessHandler = (idToDelete) => {
        ...
        return () => {
            ...
            setPageData(prevState => {
                ...
                const indexOfCertification = pageData.pagedCertifications.findIndex(cert => {
                ...
                if (indexOfCertification >= 0) {
                    ...
                    pageData.certificationsComponents = pageData.pagedCertifications.map(mapCertification);
                }
    ...
    const onSeasonSelect = (event) => {
        ...
        setPageData((prevState) => ({ ...prevState, season: selectedSeason, query: "", property: 0 }))

        if (selectedSeason === "0") {

            setRenderingData(prevState => ({ ...prevState, showAllCertifications: true, showFilteredCertifications: false }))

        } else {

            setRenderingData(prevState => ({ ...prevState, showAllCertifications: false, showFilteredCertifications: true }))
    ...
    const onSearchCertification = (event) => {
        ...
        setPageData((prevState) => ({ ...prevState, season: 0, query: certificationSearch, property: 0 }))
        ...
        if (certificationSearch === "") {
            ...
            setPageData((prevState) => {
                ...
                const newState = { ...prevState }
                newState.arrayFiltered = newState.allCertifications.filter(certObject => certObject.name.toLowerCase().indexOf(certificationSearch.toLowerCase()) >= 0);
                newState.filteredComponents = newState.arrayFiltered.map(mapCertification);
    ...
    const onFilterByProperty = (event) => {
        ...
        setPageData((prevState) => ({ ...prevState, season: 0, query: "", property: selectedProperty }))
    ...
    const filterHandler = (propertyToFilter) => {
        ...
        setPageData((prevState) => {
            ...
            const newState = { ...prevState }
            newState.arrayFiltered = newState.allCertifications.filter(certObject => certObject[propertyToFilter] === true);
            newState.filteredComponents = newState.arrayFiltered.map(mapCertification);
    ...
    const selectingConferenceId = (event) => {
        ...
        setPageData((prevState) => ({ ...prevState, season: "", query: "", property: 0 }))
        setRenderingData(prevState => ({ ...prevState, conferenceId: selectedConference, showAllCertifications: true, showFilteredCertifications: false }));
    }
    ...
    return (
        <React.Fragment>
                            ...
                            <Row className='p-3'>
                                ...
                                <Col className='col-md-3'>
                                    ...
                                    >
                                        ...
                                        <option value="2"> Background Required</option>
                                        <option value="3"> Test Required</option>
                                        <option value="4"> Fitness Required</option>
                                        <option value="5"> Clinic Required</option>
                                    </Form.Select>
                                </Col>
                                <Col className='col-md-3'>
                                    <Form.Select
            ...
            <Row>
                <div>
                    {renderingData.showAllCertifications && <Pagination
                    ...
                    />}
                    {renderingData.showFilteredCertifications && <Pagination
                        className="text-center m-3"
                        locale={locale}
                        pageSize={100}
                    />}
